...
| 기획: 주제, 컨셉, 와이어프레임, 아이콘 디자인<br />프론트엔드: 이미지 수집, 항공사 조회 페이지, `Highchart.js`, 세부 CSS<br />백엔드: 항공사 정보 및 분석 API<br />Data: 항공사 데이터 전처리 및 통계함수 로직<br />문서: README, 데이터 활용 현황, 발표 | 기획: 주제<br />프론트엔드: 기본 설정, 리뷰 분석 리포트 탭, 항공사 별 키워드 및 워드 클라우드 로직, `Highchart.js`, 리뷰 작성 페이지 <br />백엔드: pykomoran의 stable 모델 사용, 리뷰 모델 작성, 항공사 리뷰 키워드 API<br />Data: 리뷰 데이터 수집 및 전처리, 형태소 분석, word2vec 모델 및 감성분석, 불용어 처리, 리뷰 갱신<br/>문서: 발표 자료 제작, 개발 과정 및 데이터 활용 현황 문서화, UCC 기획 및 시놉시스 작성, UCC 제작 | 기획:주제<br />프론트엔드: 기본 설정, 리뷰 분석 리포트 탭 구조화, 리뷰 CRUD 로직, 네비게이션바 로직, 리뷰 리스트 디자인<br />백엔드: 모델 및 serializer 작성, 검색 로그 및 마이페이지 API 작성<br />Data: word2vec 모델 및 감성분석, 리뷰 데이터 수집 및 전처리, 형태소 분석, 모델을 활용한 벡터화, 불용어 처리<br />기타: 발표 자료 제작, 개발 과정 및 데이터 활용 현황 문서화, UCC 기획 및 시놉시스 작성, UCC 제작 | 기획: 주제, UI<br> DevOps: EC2 설정, HTTPS설정, MySQL설정, CI/CD(Jenkins) 구축<br/>프론트엔드: 기본 설정, 메인 페이지, 검색 페이지, 프로필 페이지, 네비게이션 바, 푸터<br/>  백엔드: 머신러닝 모델 사용 및 API 작성<br/> Data: 데이터 전처리 및 머신러닝<br/> 문서: 개발 과정 문서화, 포팅매뉴얼 | 기획: 주제<br>프론트엔드: 로그인 페이지, 리뷰 긍부정 비율, 상세 평점 및 전체 평점 분포, Navbar, footer, notification 알림 추가, 로그인 예외 처리<br>백엔드: 모델 및 serializer 작성, accounts 로직 구현, 로그인 데코레이터 구현, 리뷰 긍부정 비율 및 평점 로직 구현<br>Data: 리뷰 데이터 및 항공 포탈 데이터 크롤링, DB 적재<br>문서: 개발 과정 문서화, 시연 시나리오, 포팅매뉴얼<br>코드 리팩토링 |
